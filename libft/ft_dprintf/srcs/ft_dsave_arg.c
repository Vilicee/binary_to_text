...
/*   Updated: 2021/10/05 14:43:38 by wvaara           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_dprintf.h"

static void	ft_case_uns_part_two(t_dprintf *data)
{
	if (data->h == 1)
	{
...
static void	ft_case_unsigned(t_dprintf *data)
{
	if (data->hh == 1)
	{
...
static void	ft_other_cases_part_two(t_dprintf *data)
{
	if (data->ll == 1 || data->l == 1)
	{
