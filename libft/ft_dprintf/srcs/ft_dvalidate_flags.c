...
/*   Updated: 2021/10/05 14:44:51 by wvaara           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_dprintf.h"

static int	ft_skip_flags(const char *format, t_dprintf *data)
{
	int	error;
...
static int	ft_possible_flag(const char *format, t_dprintf *data)
{
	int	ret;
