...
/*   Updated: 2021/10/05 14:43:26 by wvaara           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_dprintf.h"

static void	ft_part_one(t_dprintf *data)
{
...
static int	ft_part_two(t_dprintf *data)
{
	if (data->cap_l == 1)
	{
...
static void	ft_part_four(t_dprintf *data)
{
